...
const HistoryUser = ({ data }) => {
  ...
  if (arrHistory.length === 0) return <div className='text-center text-[25px] dark:text-white'>Історії замовлень немає. <Link to='/goods' className='text-blue-600'>Перейти до товарів</Link></div>;
