...
const FormAddGoods = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='mb-6 text-[20px] dark:text-white'>Форма для додавання товарів</div>
      <form
      ...
      >
        ...
        <InputText
          ...
          type={'number'}
          name={'price'}
          placeholder={'Введіть вартість числом у гривнях'}
        />
        <InputText
        ...
        <label className='mb-2 '>
          <span className='dark:text-white'>Зображення товару:</span>
          {img?.map((item) => {
            return (
              <input
                key={uuidv4()}
