...
const FormRegistration = () => {
  ...
  return (
    <div className='flex justify-center flex-col items-center my-10'>
      <h1 className='text-[20px]'>Регестрація</h1>
      <form
        onSubmit={onSubmit}
      ...
      >
        ...
        <InputText
          labelName={'Аватар'}
          name={'avatar'}
          placeholder={'Завантажте URL аватару'}
        />
        <label>
          Тип пользователя
          <select
        ...
        <AddButton type={'submit'} text={'Зареєструватись'} />
      </form>
      <p className='mt-4'>
        Якщо ви вже зареєстровані - <Link to='/login'>ввійдіть</Link>
      </p>
    </div>
  );
};
